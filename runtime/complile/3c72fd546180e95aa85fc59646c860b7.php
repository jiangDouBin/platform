		                    ...
		                    <tr>
		                        ...
		                        <td>
		                            ...
		                            <?php if (check_level('mod')) {?>
		                            	<a href="<?php echo \core\basic\Url::get('/admin/Content/mod/mcode/'.get('mcode').'/id/'.$value->id.'');?><?php echo $this->getVar('btnqs');?>" class="layui-btn layui-btn-xs" >查看</a>
		                            <?php } ?>
		                        </td>
		                    </tr>
		                    <?php } ?>
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show">
			                ...
			                <div class="layui-form-item">
												<label class="layui-form-label">状态</label>
												<div class="layui-input-block">
													<input type="radio" name="status" value="1" title="申通通过" <?php if ($this->getVar('content')->status==1) {?> checked<?php } ?>>
							 						<input type="radio" name="status" value="0" title="未审核" <?php if ($this->getVar('content')->status==0) {?> checked<?php } ?>>
												</div>
									 </div>
			                <!-- <div class="layui-form-item">
			                     <label class="layui-form-label">来源</label>
...
<?php return array (
  ...
  1 => 'G:/github/platform/apps/admin/view/default/common/ueditor.html',
  2 => 'G:/github/platform/apps/admin/view/default/common/foot.html',
); ?>