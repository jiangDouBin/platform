		  ...
		  <div class="layui-tab-content">
		  	   <div class="layui-tab-item layui-show">
		  	   	   <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
		                 ...
		                 <div class="layui-form-item">
		                     ...
		                     <div class="layui-input-inline">
		                     	<input type="text" name="wap_domain"  value="<?php echo @$this->vars['configs']['wap_domain']['value'];?>" placeholder="如：m.pbootcms.com"  class="layui-input">
		                     </div>
		                </div>
		               ...
		               <div class="layui-form-item">
		                ...
		                <div class="layui-form-item">
		                     ...
		                     <div class="layui-input-inline">
		                     	<input type="text" name="main_domain"  value="<?php echo @$this->vars['configs']['main_domain']['value'];?>" placeholder="如：www.pbootcms.com"  class="layui-input">
		                     </div>
		                </div>
		  	   ...
		  	   <div class="layui-tab-item">
		  	    ...
		  	    <div class="layui-tab-item">
	                ...
	                <div class="layui-form-item">
	                     ...
	                     <div class="layui-input-inline">
	                     	<input type="text" name="watermark_text" value="<?php echo @$this->vars['configs']['watermark_text']['value'];?>" placeholder="请输入水印文字，如：PbootCMS" class="layui-input">
	                     </div>
	                </div>
		  	   ...
		  	   <div class="layui-tab-item">
		               ...
		               <div class="layui-form-item">
		                     ...
		                     <div class="layui-input-block">
		                     	<input type="radio" name="url_rule_sort_suffix" value="1" <?php if ($this->vars['configs']['url_rule_sort_suffix']['value']==1) {?> checked="checked" <?php } ?> title="启用">
								<input type="radio" name="url_rule_sort_suffix" value="0" <?php if ($this->vars['configs']['url_rule_sort_suffix']['value']==0) {?> checked="checked" <?php } ?> title="禁用">
		                     </div>
		                </div>
...
<script type="text/javascript" src="<?php echo APP_THEME_DIR;?>/js/mylayui.js?v=v3.0.2"></script>
...
<?php return array (
  0 => 'E:/phpstudy_pro/WWW/PbootCMS/apps/admin/view/default/common/head.html',
  1 => 'E:/phpstudy_pro/WWW/PbootCMS/apps/admin/view/default/common/foot.html',
); ?>