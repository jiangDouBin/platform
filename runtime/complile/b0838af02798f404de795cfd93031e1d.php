...
<div class="text-right position mb-3 d-none d-md-block">当前位置：{pboot:position separator='>'}</div>
    <div class="row">
      ...
      <h5 class="border-bottom border-info pb-2 mb-2"><i class="fa fa-sliders" aria-hidden="true"></i> 下载附件</h5>
			<table>
				<tr>
					<th>标题</th>
					<th>时间</th>
				...
				{pboot:uploadlist contentid={content:id}}    
  				<tr>
						<td>[uploadlist:name]</td>
						<td>[uploadlist:time]</td>
					</tr>
   			{/pboot:uploadlist}
...
<?php return array (
  ...
  1 => 'G:/github/platform/template/default/html/comm/position.html',
  2 => 'G:/github/platform/template/default/html/comm/comment.html',
  3 => 'G:/github/platform/template/default/html/comm/foot.html',
); ?>